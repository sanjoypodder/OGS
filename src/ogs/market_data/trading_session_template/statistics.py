"""
TradingSessionTemplate Statistics
"""
...
class TradingSessionTemplateStatistics(
    BaseStatistics
):
    ...
    def market_distribution(self):
        ...
        for item in self.collection:
            result[item.market] = (
                result.get(item.market, 0) + 1
            )

        return result

    def session_type_distribution(self):
        ...
        return {
            ...
            for session in TradingSessionTemplateType
        }
